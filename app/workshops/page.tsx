...
export default function WorkshopsPage() {
  return <main className="container workshop-page">
    <section className="event-hero"><div><span className="kicker">Sunday Perfumery Workshop</span><h1>Create a fragrance that is yours.</h1><p>A hands-on perfume experience in Bengaluru, designed for beginners and fragrance lovers.</p><div className="hero-actions"><Link className="button primary" href="/workshops/book">Book your seat · ₹{workshopConfig.pricePerPerson.toLocaleString('en-IN')}</Link><Link className="button" href="/shop">Explore perfumes</Link></div></div><div className="event-panel"><CalendarDays size={24}/><strong>Every Sunday</strong><small><MapPin size={14}/> {workshopConfig.location}</small></div></section>
